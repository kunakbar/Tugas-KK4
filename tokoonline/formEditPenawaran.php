<?php
	...
	$id = $_GET['id'];
	$query = mysqli_query($koneksi, "SELECT * FROM penawaran WHERE id = '$id' ");
...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="style.css"> -->
	<title>Form Edit Tanaman Penawaran Terbaik</title>
</head>
<body>
	<form action="prosesEditPenawaran.php?id=<?php echo $id; ?>" method="post">
