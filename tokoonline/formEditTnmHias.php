<?php
	...
	$id = $_GET['id'];
	$query = mysqli_query($koneksi, "SELECT * FROM tnmHias WHERE id = '$id' ");
...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="style.css"> -->
	<title>Form Edit Tanaman Bunga</title>
</head>
<body>
	<form action="prosesEditTnmHias.php?id=<?php echo $id; ?>" method="post">
